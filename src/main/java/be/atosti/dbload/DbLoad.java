...
/*            ClubProcessor.ClubProcessorFactory(Paths.get("src/main/resources/data/tmp", "clubs.csv")).load(connection);
            ...
            BaseTeamProcessor.BaseTeamProcessorFactory(Paths.get("src/main/resources/data/fixed/2016-2017", "liga_nationale_basisopstelling.csv")).load(connection);*/
            LocationsProcessor.LocationsProcessorFactory(Paths.get("src/main/resources/data/tmp", "locations.csv")).load(connection);
